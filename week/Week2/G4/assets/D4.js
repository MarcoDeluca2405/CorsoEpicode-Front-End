const starWarsCharacters = [
  ...
  */
  for(var i=0; i < starWarsCharacters.length; i++){
    let a= starWarsCharacters[i].name;
    characters.push(a);
  }
  ...
  */
  ...
  var eyeColor = {blue: [], yellow: [], brown:[], blueGrey:[]};
  ...
  /* ESERCIZIO 6
    ...
    */
    ...
    while(numero < starWarsCharacters.length){
    totale= Number(starWarsCharacters[numero].mass) +totale;
    numero++;
    }
    console.log(totale);
  ...
  */
  for(let i = 0; i < femaleCharacters.length; i++){
    ...
    for (let i2 = 0; i2 < characters.length; i2++){
        ...
        if(femaleCharacters[i].name==characters[i2]){
            
            characters.splice(i2,1);
